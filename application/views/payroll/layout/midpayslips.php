...
<head>
    <meta charset="UTF-8">
    <title>EVSU Mid-Year Payslip</title>
    <style>
        @page {
...
<div class="payslip">
    <div class="header-container">
        ...
        <div class="header-text">
            <h2>Mid-Year Payslip</h2>
            <p>EASTERN VISAYAS STATE UNIVERSITY</p>
            <span class="period-label">Period: Mid-Year Bonus CY-<?= isset($p->date_period) ? $p->date_period : 'Mid-Year Bonus' ?></span>
        </div>
    </div>
    ...
    <table>
        <?php 
        // 1. Initialize our dynamic total
        $calculated_total = 0;
        
        // 2. Add the tax to our total right away
        $calculated_total += (float)$p->tax;

        // 3. Process the other adjustments
        if (!empty($p->less)): 
            ...
            foreach ($adjustments as $adjustment):
                ...
                if (count($parts) == 2):
                    ...
                    // Add this specific adjustment to our running total!
