                ...
                <div class="card-body">
                    <form id="bpForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pagibig_no" class="form-control form-control-sm" required>
                        </div>

                        <button type="submit" class="btn btn-success btn-sm w-100">
                            <i class="bi bi-save"></i> Save Pagibig Number
                        </button>
            ...
            <div class="card shadow-sm mt-3">
                ...
                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        ...
                        Pagibig Remittance - Payroll List
                    </h5>

                    <div class="btn-group btn-group-sm">
                        <button class="btn btn-light active" id="btnPayroll">Payroll List</button>
                        <button class="btn btn-light" id="btnEmployees">Employee Paibig</button>
                    </div>
                </div>
                            ...
                            <table id="employeeTable" class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $e->pagibig_no 
                                                ? '<span class="fw-bold">'.$e->pagibig_no.'</span>' 
...
$(document).ready(function(){
    ...
    $(document).on('click', '.payrollRow', function(){
        ...
        window.location.href = "<?= base_url('payroll/pagibig_remittance/') ?>" + payroll_period_id;
    });
...
$('#bpForm').submit(function(e){
    ...
    $.post("<?= base_url('payroll/save_pagibig_number') ?>", $(this).serialize(), function(res){
        ...
        if(res.status){
            Swal.fire('Success', 'Pagibig number saved!', 'success');
...
$(document).ready(function(){
    ...
    $(document).on('click', '.editBP', function(){
        ...
        $('input[name="pagbibig_no"]').val(pagibig_no);
